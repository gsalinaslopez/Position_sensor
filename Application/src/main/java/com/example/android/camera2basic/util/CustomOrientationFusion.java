...
public abstract class CustomOrientationFusion implements BaseFilter {
    private static final float EPSILON = 0.000000001f;
    // Nano-second to second conversion
    private static final float NS2S = 1.0f / 1000000000.0f;
    private static final String tag = CustomOrientationFusion.class.getSimpleName();
     ...
     */
    public CustomOrientationFusion() {
        this(DEFAULT_TIME_CONSTANT);
    }

    public CustomOrientationFusion(float timeConstant) {
